...
<?php echo $this->Form->create('BlocksAdvertisement'); ?>
	<fieldset>
		<legend><?php echo __d('publicity','Edit Blocks Advertisement'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__d('publicity','Delete'), array('action' => 'delete', $this->Form->value('BlocksAdvertisement.id')), null, __d('publicity','Are you sure you want to delete # %s?', $this->Form->value('BlocksAdvertisement.id'))); ?></li>
