...
<div class="span8">
	<h2><?php echo __d('advertising','Blocks Advertisements'); ?></h2>
	<?php
		...
		<tbody>
			<?php foreach ($blocksAdvertisements as $blocksAdvertisement): ?>
				<tr>
					...
					<td class="actions">
						<?php echo $this->Html->link(__d('advertising','View'), array('action' => 'view', $blocksAdvertisement['BlocksAdvertisement']['id'])); ?>
						<?php echo $this->Html->link(__d('advertising','Edit'), array('action' => 'edit', $blocksAdvertisement['BlocksAdvertisement']['id'])); ?>
						<?php echo $this->Form->postLink(__d('advertising','Delete'), array('action' => 'delete', $blocksAdvertisement['BlocksAdvertisement']['id']), null, __d('advertising','Are you sure you want to delete # %s?', $blocksAdvertisement['BlocksAdvertisement']['id'])); ?>
					</td>
				</tr>
			<?php endforeach; ?>
		</tbody>
